...
problem_schema = Map({'Board': Map({'Size': SizeParser(), 'Digits': BoardDigitsParser(), Optional('Tags'): Map(
    {Optional('Title'): Str(), Optional('Reference'): Str(), Optional('Video'): Str(), Optional('Author'): Str()})}),
                      'Constraints': Map({Optional('Battenburg'): CellListParser(), Optional('Item'): NoneParser(),
                                          Optional('Cell'): NoneParser(), Optional('ComposedItem'): NoneParser(),
                                          Optional('Region'): NoneParser(), Optional('StandardRegion'): NoneParser(),
                                          Optional('Box'): DigitParser(), Optional('RegionSet'): NoneParser(),
                                          Optional('StandardRegionSet'): NoneParser(), Optional('Boxes'): BoxParser(),
                                          Optional('CellReference'): Seq(CellParser()),
                                          Optional('Column'): DigitParser(), Optional('Columns'): NoneParser(),
                                          ...
                                          Optional('Known'): Seq(KnownParser()), Optional('LowCell'): Seq(CellParser()),
                                          Optional('MidCell'): Seq(CellParser()),
                                          Optional('OddCell'): Seq(CellParser()),
                                          Optional('Product'): Seq(CellValueParser()), Optional('Row'): DigitParser(),
                                          Optional('Rows'): NoneParser(), Optional('SpecialRegion'): NoneParser(),
