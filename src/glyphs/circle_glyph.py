...
This module defines the `CircleGlyph` class, which represents a circular glyph
to be drawn on an SVG canvas. It supports configurable positioning and scaling
of the circle relative to the cell size.
"""
