...
This module defines the `ArrowGlyph` class, which represents an arrow glyph to be drawn on an SVG canvas.
It supports specifying the class name, angle, and position of the arrow.
"""
