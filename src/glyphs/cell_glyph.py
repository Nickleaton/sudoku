...
This module defines the `CellGlyph` class, which represents a cell glyph to be drawn
on an SVG canvas. It inherits from `SquareGlyph` and provides properties and methods
to manage cell-related glyphs.
"""
