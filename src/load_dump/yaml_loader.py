...
class YamlLoader(Loader):
    """A Loader subclass that loads board line from start YAML file_path."""
    ...
    def process(self) -> Board:
        """Process the loaded YAML line and creates start Board instance.

        This method takes the raw YAML line and uses it to create start Board instance.
