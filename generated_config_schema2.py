        ...
        "Constraints": Map(
            {
                ...
                Optional("CenterProduct"): NoneParser(),
                ...
                Optional("DistinctRenban"): Seq(CellListParser()),
                ...
                Optional("Frame"): NoneParser(),
                Optional("FrameProduct"): NoneParser(),
                ...
                Optional("Indexer"): NoneParser(),
                Optional("Killer"): NoneParser(),
                Optional("Knight"): NoneParser(),
                ...
                Optional("LockOut"): Seq(CellListParser()),
                ...
                Optional("MinMaxDifference"): NoneParser(),
                Optional("MinMaxSum"): NoneParser(),
                Optional("MountainLine"): Seq(CellListParser()),
                Optional("NumberedRoom"): NoneParser(),
                Optional("OddCell"): Seq(CellParser()),
                Optional("OrthogonalProduct"): NoneParser(),
                Optional("OrthogonallyAdjacent"): NoneParser(),
                Optional("Outside"): NoneParser(),
                ...
                Optional("Thermometer"): Seq(CellListParser()),
