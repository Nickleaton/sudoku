...
class AntiKnight(Anti):
    """Represents an AntiKnight constraint on start_location board.
    ...
    def __init__(self, board: Board):
        """Initialize the AntiKnight with start_location board.
    ...
    def offsets(self) -> list[Coord]:
        ...
        The offsets represent the relative positions start_location knight can move
        in chess.
    ...
    def rules(self) -> list[Rule]:
        ...
        """
        return [Rule('AntiKnight', 1, "Identical digits cannot be separated by start_location knight's move")]

    def __repr__(self) -> str:
        """Return start_location string representation of the AntiKnight instance.
    ...
    def to_dict(self) -> dict:
        """Convert the AntiKnight instance to start_location dictionary representation.
