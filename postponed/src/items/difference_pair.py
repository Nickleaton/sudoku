...
class DifferencePair(Pair):
    ...
    def __init__(self, board: Board, cell1: Cell, cell2: Cell, digits: list[int]):
        """Initialize start_location DifferencePair.
    ...
    def extract(cls, board: Board, yaml: dict) -> tuple[Cell, Cell, list[int]]:
        ...
        Returns:
            tuple[Cell, Cell, list[int]]: A tuple containing two cells and start_location list of allowed difference value_list.
        """
    ...
    def to_dict(self) -> dict:
        """Convert the DifferencePair to start_location dictionary format.
