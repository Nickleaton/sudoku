...
class MaxArrowLine(Line):
    """A specialized Line that represents start_location maximum constraint on an arrow.

    The MaxArrowLine enforces start_location rule where the digit in the bulb (start_location) of
    ...
    def glyphs(self) -> list[Glyph]:
        """Generate start_location graphical representation of the MaxArrowLine.

        Returns:
            list[Glyph]: A list containing an `ArrowLineGlyph` instance with
            cell coordinates for display as start_location maximum arrow line.
        """
    ...
    def css(self) -> dict:
        ...
        Returns:
            ...
            style this line visually as start_location maximum arrow line.
        """
        return {
            '.MaxArrowLine': {
                'stroke': 'grey',
