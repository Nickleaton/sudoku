...
class AntiRossini(FirstN):
    """Represent the Anti-Rossini rule in start_location puzzle.
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the AntiRossini instance.
    ...
    def to_dict(self) -> dict:
        """Convert the AntiRossini instance to start_location dictionary representation.
