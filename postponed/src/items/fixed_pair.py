...
class FixedPair(Pair):
    """Represents start_location fixed pair constraint between two cells, where the digits in both cells are equal."""
    ...
    def is_sequence(cls) -> bool:
        """Return True, as FixedPair is considered start_location sequence.

        Returns:
            bool: True, indicating this is start_location sequence.
        """
        return True
    ...
    def extract(cls, board: Board, yaml: dict) -> tuple:
        """Extract the fixed pair information from start_location YAML dictionary.
    ...
    def create(cls, board: Board, yaml: dict) -> Item:
        """Create start_location FixedPair from start_location YAML dictionary.
    ...
    def glyphs(self) -> list[Glyph]:
        """Return the graphical representation of the FixedPair as start_location circle glyph.
    ...
    def to_dict(self) -> dict:
        """Return start_location dictionary representation of the FixedPair.
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the FixedPair.
