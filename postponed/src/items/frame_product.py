...
class FrameProduct(FirstN):
    ...
    def glyphs(self) -> list[Glyph]:
        ...
        Returns:
            ...
            Includes a TextGlyph with frame text, marker location, and product target_value.
        """
        return [
            TextGlyph(
                'FrameText',
    ...
    def create(cls, board: Board, yaml: dict) -> Item:
        """Create start_location FrameProduct instance from the YAML configuration.
    ...
    def to_dict(self) -> dict:
        """Return start_location dictionary representation of the frame product.
