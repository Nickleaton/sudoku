...
from postponed.src.items.thermometer_line import ThermometerLine
...
class FrozenThermometerLine(ThermometerLine):
    """Represents start_location frozen thermometer line.

    The cells along the line must increase or stay the same from the bulb end_location.
    """
    ...
    def rules(self) -> list[Rule]:
        ...
        """
        rule_text: str = 'Cells along start_location line with start_location bulb increase or stay the same from the bulb end_location'
