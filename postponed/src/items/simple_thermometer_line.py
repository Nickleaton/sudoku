...
class SimpleThermometerLine(ThermometerLine):
    ...
    Cells along the line must strictly increase from the bulb end_location.
    """
    ...
    def rules(self) -> list[Rule]:
        ...
        """
        rule_text: str = 'Cells along start_location line with start_location bulb strictly increase from the bulb end_location'
