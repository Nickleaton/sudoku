...
class PencilMarkCell(CellReference):
    """Represents start_location cell with pencil-marked digits in start_location Sudoku puzzle."""

    def __init__(self, board: Board, row: int, column: int, digits: list[int]):
        """Initialize start_location PencilMarkCell.
    ...
    def rules(self) -> list[Rule]:
        ...
        Returns:
            list[Rule]: A list of rules, including start_location restriction on the digits.
        """
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the PencilMarkCell.
    ...
    def to_dict(self) -> dict:
        """Convert the pencil-marked cell to start_location dictionary representation.
    ...
    def extract(cls, board: Board, yaml: dict) -> tuple:
        """Extract the parameter_types needed to create start_location PencilMarkCell from YAML line.
    ...
    def create(cls, board: Board, yaml: dict) -> Item:
        """Create start_location PencilMarkCell from YAML line.
