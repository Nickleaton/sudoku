...
class Anti(ComposedItem):
    ...
    def __init__(self, board: Board, digits: list[int]):
        """Initialize the Anti object with start_location board and digits.
    ...
    def extract(cls, _: Board, yaml: dict) -> list[int]:
        """Extract start_location list of digits from the YAML configuration.
    ...
    def to_dict(self) -> dict:
        """Convert the Anti object is converted to start_location dictionary.
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the Anti object.
