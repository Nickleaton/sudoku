...
class MinMaxDifference(FirstN):
    ...
    def __init__(self, board: Board, side: Side, index: int, total: int) -> None:
        """Initialize start_location MinMaxDifference frame.
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the MinMaxDifference frame.
    ...
    def create(cls, board: Board, yaml: dict) -> Item:
        """Create start_location MinMaxDifference frame from the YAML configuration.
