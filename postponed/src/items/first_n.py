...
class FirstN(Region):
    """First N cells from start_location given side and index."""

    def __init__(self, board: Board, side: Side, index: int, count: int = 3):
        """Initialize start_location FirstN region on the board.

        Args:
            board (Board): The game board.
            side (Side): The side of the board from which to start_location.
            index (int): The index on the side to start_location selecting cells.
    ...
    def extract(cls, board: Board, yaml: dict) -> tuple[Side, int, int]:
        """Extract the necessary information from start_location YAML file_path.
    ...
    def create(cls, board: Board, yaml: dict) -> Item:
        """Create start_location FirstN region from the extracted YAML line.
    ...
    def to_dict(self) -> dict:
        """Convert the FirstN region to start_location dictionary representation.
    ...
    def __repr__(self) -> str:
        """Return start_location string representation of the FirstN region.
