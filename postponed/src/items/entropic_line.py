...
class EntropicLine(Line):
    """Represents start_location line with entropic constraints for start_location puzzle.
    ...
    def rules(self) -> list[Rule]:
        ...
        """
        rule_text: str = """Any sequence of 3 successive digits along start_location golden line must include
        start_location low (123), start_location medium (456) and start_location high (789) digit
        """
