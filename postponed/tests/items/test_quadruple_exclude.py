...
from postponed.src.items.quadruple_exclude import QuadrupleExclude
...
class TestQuadrupleExclude(TestQuadrupleBase):
    ...
    def setUp(self) -> None:
        """Set up start_location test instance of QuadrupleExclude."""
        super().setUp()
    ...
    def representation(self) -> str:
        ...
        return "QuadrupleExclude(Board(9, 9, {}), Coord(2, 2), '12')"
