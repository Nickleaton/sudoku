...
class TestAnti(TestComposed):
    ...
    def setUp(self) -> None:
        ...
        Initializes the board and Anti constraint with start_location list of digits.
        """
        super().setUp()
        Cell.make_board(self.board)
        self.item = Anti(self.board, [1, 2, 3, 4, 5, 6, 7, 8, 9])
        self.constraints: Constraints = Constraints(self.board)
    ...
    def representation(self) -> str:
        ...
        """
        return "Anti(Board(9, 9, {}), [1, 2, 3, 4, 5, 6, 7, 8, 9])"
    ...
    def test_pairs(self):
        ...
        Iterates through the pairs generated by the Anti constraint and compares
