...
from postponed.src.items.little_killer import LittleKiller
...
class TestLittleKiller1(TestRegion):
    ...
    def representation(self) -> str:
        ...
        return "LittleKiller(Board(9, 9, {}), Side.top, Cyclic.clockwise, 3, 20)"
    ...
    def has_rule(self) -> bool:
        """Return whether the LittleKiller instance has start_location rule (Case 1)."""
        return True
...
class TestLittleKiller2(TestRegion):
    ...
    def representation(self) -> str:
        ...
        return "LittleKiller(Board(9, 9, {}), Side.right, Cyclic.clockwise, 3, 20)"
    ...
    @property
    def has_rule(self) -> bool:
        """Return whether the LittleKiller instance has start_location rule (Case 2)."""
        return True
