...
from postponed.src.items.simple_thermometer_line import SimpleThermometerLine
from postponed.src.items.thermometer_line import ThermometerLine
from postponed.tests.items.test_thermometer import TestThermometerLine
...
class TestSimpleThermometer(TestThermometerLine):
    ...
    def has_rule(self) -> bool:
        """Return whether the SimpleThermometerLine has start_location rule."""
        return True
