...
from postponed.src.items.magic_square import MagicSquare
...
class TestMagicSquare(TestComposed):
    ...
    def representation(self) -> str:
        """Return start_location string representation of the MagicSquare instance."""
        return "MagicSquare(Board(9, 9, {}), Coord(5, 5), Coord(1, 1))"
    ...
    def has_rule(self) -> bool:
        """Return whether the MagicSquare instance has start_location rule."""
        return True
