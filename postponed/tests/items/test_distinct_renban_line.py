...
from postponed.src.items.distinct_renban_line import DistinctRenbanLine
from postponed.src.items.line import Line
from postponed.src.items.renban_line import RenbanLine
from postponed.tests.items.test_renban_line import TestRenbanLine
...
class TestDistinctRenbanLine(TestRenbanLine):
    ...
    def has_rule(self) -> bool:
        """Return whether the DistinctRenbanLine has start_location rule."""
        return True
